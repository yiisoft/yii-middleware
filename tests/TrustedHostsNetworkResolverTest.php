...
final class TrustedHostsNetworkResolverTest extends TestCase
{
    ...
    public function testTrusted(
        ...
        $middleware = new TrustedHostsNetworkResolver(new Validator(new SimpleRuleHandlerContainer()));
    ...
    public function testAddedTrustedHostsInvalidParameter(array $data, bool $isRuntimeException = false): void
    {
        ...
        (new TrustedHostsNetworkResolver(new Validator(new SimpleRuleHandlerContainer())))
    ...
    public function testProcessWithAttributeIpsAndWithoutActualHost(): void
    {
        ...
        $requestHandler = new MockRequestHandler();
        $response = (new TrustedHostsNetworkResolver(new Validator(new SimpleRuleHandlerContainer())))->withAttributeIps('ip')->process($request, $requestHandler);
    ...
    public function testAttributeIpsInvalidWhenEmptyString(): void
    {
        ...
        (new TrustedHostsNetworkResolver(new Validator(new SimpleRuleHandlerContainer())))->withAttributeIps('');
    }
