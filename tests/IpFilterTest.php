...
final class IpFilterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->ipFilter = new IpFilter(validator: new Validator(new SimpleRuleHandlerContainer()), responseFactory: $this->responseFactoryMock, ipRanges: [self::ALLOWED_IP]);
    }
    ...
    public function testProcessCallsRequestHandlerWithSetClientIpAttribute(): void
    {
        ...
        $ipFilter = new IpFilter(new Validator(new SimpleRuleHandlerContainer()), $this->responseFactoryMock, $attributeName, [self::ALLOWED_IP]);
        $response = $ipFilter->process($requestMock, $this->requestHandlerMock);
