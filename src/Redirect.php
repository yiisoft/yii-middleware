...
final class Redirect implements MiddlewareInterface
{
    ...
    /**
     * @var array<string, \Stringable|scalar|null> $parameters
     */
     ...
     * @param array<string, \Stringable|scalar|null> $parameters $parameters The route parameters for redirection.
     */
